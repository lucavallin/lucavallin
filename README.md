...
Back in 2015, I made the move from Italy to The Netherlands. Since then, I've been diving into all sorts of projects, wearing different hats along the way. Besides my main skills and interests, I've also jumped into areas like Google Cloud (and its certifications), .NET, several databases, REST APIs, TypeScript, React.js, Agile Methodologies, consultancy, giving trainings, hosting meetups and podcasts, and then some.
